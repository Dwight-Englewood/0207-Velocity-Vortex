...
//@Disabled
@Autonomous(name = "Shoot Drive FAR", group = "ITERATIVE_AUTON")
public class ShootDriveFarThing extends OpMode {
    ...
    public void loop()
    {
        ...
        switch (commandNumber)
        {
            ...
            case 2:
                ...
                else if (timer.milliseconds() < 7000)
                {
                    robot.setShooter(0);
                    robot.setElevator(1);
                }
                ...
                else if (timer.milliseconds() < 8500 )
                {
                    robot.setShooter(1);
                }
                else if (timer.milliseconds() > 8500)
